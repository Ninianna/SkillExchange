...
<body style="background-color:#FFFFB5;margin:0;font-family: '微軟正黑體'";>
    ...
    <form action="{{route('reset-password')}}" method="POST">
      @csrf
      <input type="hidden" name="reset_pwd_token" value="{{$token}}">
      <input type="password" class="Input" name="password" placeholder="請輸入新密碼">
      <input type="submit" class="OptionButton" vlaue="修改">
    </form>
